...
module.exports = [
   ...
   */
  {
    ...
    output: {
      filename: 'index.js',
      path: path.resolve(__dirname, 'juicebox-jupyter', 'nbextension', 'static'),
      libraryTarget: 'amd',
      // TODO: Replace after release to unpkg.org
      publicPath: '' // 'https://unpkg.com/@igvteam/juicebox-jupyter@' + version + '/dist/'
    },
    module: {
      rules: rules
    },
   ...
   */
  {
    ...
    output: {
        ...
        libraryTarget: 'amd',
        library: "@igvteam/juicebox-jupyter",
        // TODO: Replace after release to unpkg.org
        publicPath: '' // 'https://unpkg.com/@igvteam/juicebox-jupyter@' + version + '/dist/'
    },
    module: {
